...
function FlushChart(data1, data2) {
    ...
    footChart.series[0].setData([data2.PPH.InLastHour]);
    footChart.series[1].setData([data2.PPH.InDay ]);
}

function InitBarChart(data1, data2) {
    var num1, num2, num3, num4;
    var jhsl, jhdcl,xl,ztl;
    if (data1 == undefined) {
    ...
    $('#RightCanvas').highcharts({
        ...
        series: [
            ...
            name: '实际%',
            data: [
               { y: jhdcl, color: '#87bb4f', borderColor: '#87bb4f' }, { y: xl, color: '#87bb4f', borderColor: '#87bb4f' }, { y: ztl, color: '#87bb4f', borderColor: '#87bb4f' }]
        }, {
            name: '标准%',
            data: [{}, {},{}]
        }]
    ...
    $('#FootCanvas').highcharts({
        ...
        series: [

            {
                ...
                name: '标准',
                data: [{ y: num8, color: '#00b0f0', borderColor: '#00b0f0' }]
            }]
    });
