...
function FlushChart(data1, data2) {
    leftChart.series[0].setData([data1.Real.InLastHour, data1.Real.InDay]);
    leftChart.series[1].setData([data1.Standard.InLastHour, data1.Standard.InDay]);

    rightChart.series[0].setData([data2.Effciency.InLastHour, data2.PPH.InLastHour]);
    rightChart.series[1].setData([data2.Effciency.InDay, data2.PPH.InDay]);
}
...
function InitBarChart(data1, data2) {
    ...
    $('#LeftCanvas').highcharts({
        ...
        series: [{
            name: '实际',
            data: [{ y: num1, color: '#87bb4f', borderColor: '#87bb4f' }, { y: num2, color: '#87bb4f', borderColor: '#87bb4f' }]
        }, {
            name: '标准',
    ...
    $('#RightCanvas').highcharts({
        ...
        series: [{
            name: '最近小时',
            data: [{ y: num5, color: '#87bb4f', borderColor: '#87bb4f' }, { y: num6, color: '#87bb4f', borderColor: '#87bb4f' }]
        }, {
            name: '当日累计',
            data: [{ y: num7, color: '#00b0f0', borderColor: '#00b0f0' }, { y: num8, color: '#00b0f0', borderColor: '#00b0f0' }]
        }]
    });
